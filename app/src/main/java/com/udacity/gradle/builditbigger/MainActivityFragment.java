...
import static com.udacity.gradle.builditbigger.EndPointsAsyncTask.JOKES_LIST;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences sharedPref = getContext().getSharedPreferences("JokesPrefs", Context.MODE_PRIVATE);
                String joke = sharedPref.getString(JOKES_LIST, "");
